...
const fabClass =
  "flex flex-col items-center justify-center gap-1 min-w-0 flex-1 py-1 active:scale-95 transition-transform";
  ...
  return createPortal(
    <>
      ...
      <nav
        ...
        className="md:hidden fixed inset-x-0 bottom-0 z-[9998] pointer-events-none glass-card-light rounded-none border-t border-border/40 pb-[env(safe-area-inset-bottom,0px)] shadow-[0_-8px_32px_rgba(0,0,0,0.08)]"
      >
        <div className="flex items-stretch justify-around gap-1 px-2 pt-2 pb-2 pointer-events-auto max-w-lg mx-auto">
          <a href={PHONE_LINK} className={fabClass} aria-label="Call us">
            <span className="w-11 h-11 rounded-full bg-[#25D366] flex items-center justify-center shadow-md">
      ...
      <div
        className="fixed right-3 sm:right-6 z-[9999] flex flex-col items-end gap-2.5 pointer-events-none bottom-[calc(4.75rem+env(safe-area-inset-bottom,0px))] md:bottom-[calc(1.5rem+env(safe-area-inset-bottom,0px))]"
        aria-hidden={false}
      >
        {showPassIcon && (
          <div
          ...
          >
            <span className="px-2.5 py-1 rounded-full glass-card-light text-foreground text-[10px] sm:text-xs font-semibold whitespace-nowrap max-w-[calc(100vw-5rem)] truncate shadow-sm">
