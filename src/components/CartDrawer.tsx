  ...
  return (
    <>
      ...
      <aside
        ...
        className="fixed top-0 right-0 h-[100dvh] w-full max-w-full sm:max-w-[400px] bg-background border-l border-border z-[61] shadow-2xl flex flex-col animate-in slide-in-from-right duration-300"
      >
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain px-4 sm:px-5 py-4 touch-pan-y [-webkit-overflow-scrolling:touch]">
          {items.length === 0 ? (
