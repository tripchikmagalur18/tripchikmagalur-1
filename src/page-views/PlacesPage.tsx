...
import placesMap from "@/assets/places-map.webp";
import siriNature from "@/assets/place-siri-nature.webp";
import jhariFalls from "@/assets/place-jhari-falls.webp";
import mullayangiri from "@/assets/place-mullayangiri.webp";
import seethalayngiri from "@/assets/place-seethalayngiri.webp";
import honnammaFalls from "@/assets/place-honnamma-falls.webp";
import bababudangiri from "@/assets/place-bababudangiri.webp";
import manikyadhara from "@/assets/place-manikyadhara.webp";
import zpoint from "@/assets/place-zpoint.webp";
import ziplining from "@/assets/place-ziplining.webp";
import deviramma from "@/assets/place-deviramma.webp";
import kalhattiFalls from "@/assets/place-kalhatti-falls.webp";
import kemmanagundi from "@/assets/place-kemmanagundi.webp";
import rajbhavan from "@/assets/place-rajbhavan.webp";
...
import ukkuda from "@/assets/place-ukkuda.webp";
import bandekal from "@/assets/place-bandekal.webp";
    ...
    <Dialog open={!!place} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className="max-w-2xl p-0 overflow-hidden max-h-[90vh] overflow-y-auto">
        <div className="relative h-56 sm:h-64 w-full overflow-hidden">
          <AppImage src={place.image} alt={place.name} fill sizes="100vw" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-lg">
              Discover 30+ destinations across 5 days. Book{" "}
              <Link href="/chikmagalur-tour-packages" className="text-sunset font-medium hover:underline">
                Chikmagalur tour packages
              </Link>{" "}
              with transport, or plan routes using our{" "}
              <Link href="/chikmagalur-itinerary" className="text-sunset font-medium hover:underline">
                full itinerary
              </Link>{" "}
              and{" "}
              <Link href="/2-day-chikmagalur-itinerary" className="text-sunset font-medium hover:underline">
                2-day weekend plan
              </Link>
              .
            </p>
          ...
          {/* Map */}
          <div className="relative max-w-4xl mx-auto rounded-3xl overflow-hidden border border-border/50 shadow-2xl group aspect-[16/10]">
            <AppImage
              src={placesMap}
              alt="Chikmagalur tourist map showing Mullayanagiri, Hebbe Falls and places to visit routes"
              fill
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-sm text-muted-foreground mb-8 max-w-xl mx-auto">
            Each day matches our guided tours — e.g. Day 1 sights on the{" "}
            <Link href="/mullayanagiri-trek-package" className="text-sunset font-medium hover:underline">
