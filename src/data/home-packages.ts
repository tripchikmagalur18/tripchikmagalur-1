...
export const homeFaqItems = [
  ...
  {
    question: "What is included in a Chikmagalur tour package?",
    answer:
      "Day packages include private cab, driver, fuel, local guide, and entry coordination for listed stops. Jeep rides to waterfalls and adventure add-ons can be bundled. Stays and meals are booked separately on our Stays page.",
  },
  {
